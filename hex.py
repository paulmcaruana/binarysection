# for i in range (17):
#     print("{0:>2} in hex is {0:>02x}".format(i)) # prints the decimal value and shows what it is in hex up to but not including 17
#
# x = 0x20
# y = 0x0a
#
...
powers = []
for power in range(15, -1, -1): # need to reduce the 15 as its too high for what we would do in octal
    powers.append(2 ** power) # can change the 2 to an 8 to get it to oct
